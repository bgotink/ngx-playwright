...
export class MainComponentHarness extends ComponentHarness {
  ...
  readonly clickModifiersResult = this.locatorFor(
    '.click-modifiers-test-result',
  );
  readonly singleSelect = this.locatorFor('#single-select');
  readonly singleSelectValue = this.locatorFor('#single-select-value');
  readonly singleSelectChangeEventCounter = this.locatorFor(
  ...
  readonly multiSelectChangeEventCounter = this.locatorFor(
  ...
  readonly nullComponentHarness = this.locatorForOptional(
  ...
  readonly fourItemLists = this.locatorForAll(
    SubComponentHarness.with({itemCount: 4}),
  );
  readonly toolsLists = this.locatorForAll(
  ...
  readonly subcomponentHarnessesAndElements = this.locatorForAll(
    '#counter',
    SubComponentHarness,
  );
