// Keep using any and Function to ensure compatibility with Angular's interfaces
...
import type {TestKey as _AngularTestKey} from "@angular/cdk/testing";

import type {ElementDimensions} from "./element-dimensions.js";
...
type AngularTestKey = boolean extends _AngularTestKey ? never : _AngularTestKey;
...
export interface TestElement {
	 ...
	 */
	sendKeys(...keys: (string | TestKey | AngularTestKey)[]): Promise<void>;
	...
	sendKeys(
		modifiers: ModifierKeys,
		...keys: (string | TestKey | AngularTestKey)[]
	): Promise<void>;
